...
const PaymentSuccess = () => {
  return (
    <div className=" min-h-[calc(100vh-65px)] bg-[#F2F4F8] ">
      <Container>
        <div className="min-h-screen flex justify-center items-center flex-col">
          ...
          <div className=" flex justify-center items-center">
            <Link to="/">
              <Button className="bg-[#b33000]  font-semibold py-1.5 px-2 rounded-lg hover:bg-[#ff4500] transition duration-300 shadow-md hover:shadow-lg mt-4">
                Back to home
              </Button>
            </Link>
          </div>
